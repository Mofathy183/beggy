...
import { STATUS_CODE, STATUS_MESSAGE, type StatusCode } from "@shared/constants"
...
export class ApiResponse {
    ...
    constructor (public message: string, public status: StatusCode) {
		/**
		 * The HTTP status statement of the response.
		 * @type {string}
		 */
		this.statement = STATUS_MESSAGE[status];
    }
