...
import type { MoveItemInput } from '@beggy/shared/types';
					...
					<FieldGroup>
						...
						<Controller
							...
							render={({ field, fieldState }) => {
								...
								// Resolve the display name for the currently
								// selected bag — so SelectValue shows the bag
								// name, never a raw UUID.
