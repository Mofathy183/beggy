...
//* route for create item for User Bag => POST (body itemId) (params id) user must by login
...
//* route for create items for User Bag => POST (params id) user must by login
...
//* route for delete Item By its Id From User's Bag => DELETE (params id) user must by login
...
//* route for delete Items By They Ids From User's Bag => DELETE (params id) user must by login
...
//* route for delete All Items From User's Bag => DELETE (params id) user must by login
