...
export enum ErrorCode {
	...
	CONTAINER_ITEM_NOT_FOUND = 'CONTAINER_ITEM_NOT_FOUND',
	CONTAINER_OVERWEIGHT = 'CONTAINER_OVERWEIGHT',
	CONTAINER_OVER_CAPACITY = 'CONTAINER_OVER_CAPACITY',
	CONTAINER_ITEM_QUANTITY_INVALID = 'CONTAINER_ITEM_QUANTITY_INVALID',
	SAME_CONTAINER_MOVE = 'SAME_CONTAINER_MOVE',
